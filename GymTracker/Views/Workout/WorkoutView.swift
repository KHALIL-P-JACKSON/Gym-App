...
/// The workout logging screen. The user picks preset exercises, enters
/// sets as fast as possible, and finishes to persist everything.
struct WorkoutView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text(AppFormatters.longDate(.now))
                .font(.subheadline)
